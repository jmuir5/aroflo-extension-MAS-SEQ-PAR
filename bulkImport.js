...
function importData(techLocations, index23) {
  ...
  chrome.storage.sync.get("inputtag", async ({ inputtag }) => {
    ...
    document
      .getElementById("btnOptSaveOrganisation")
      .addEventListener("click", async () => {
        ...
        var buttons = document.getElementsByClassName(
          "afBtn afBtn__fill afBtn--small af-primary"
        );
    ...
    while (document.getElementById("Name")) {
      ...
      console.log("waiting for name");
      if (
        document.getElementsByClassName("pac-item googleplacesItem").length ==
          1 &&
    ...
    while (document.getElementById("dialog_search_clients")) {
      ...
      if (document.getElementById("globalsearch_value")) {
        if (document.getElementById("globalsearch_value").value == "") {
          document.getElementById("globalsearch_value").value =
            inputtag[0] + " " + inputtag[1];
    ...
    if (inputtag[9] == "Other") {
      document.querySelectorAll("[id='assetName']")[1].value =
        inputtag[8] + " " + inputtag[9];
    } else {
      document.querySelectorAll("[id='assetName']")[1].value =
        inputtag[8] + " " + inputtag[9].slice(0, inputtag[9].length - 1);
    }
    ...
    while (document.getElementById("categoryName")) {
      if (inputtag[9] != "Cooktops") {
        document
          .getElementsByClassName("afBtn--small afBtn__fill af-success")[0]
          .click();
        break;
      }
      await new Promise((r) => setTimeout(r, 10));
    ...
    if (document.getElementById("_Cust299"))
      document.getElementById("_Cust299").value = "Online Booking";
    if (document.getElementById("_Cust300"))
      document.getElementById("_Cust300").value = "Online Booking";
    if (document.getElementById("_Cust301"))
      document.getElementById("_Cust301").value = "Online Booking";
    //opentask in new tab
    if (document.getElementsByClassName("afBtnGroup").length > 0) {
      document
        .getElementById("btnDoneScheduleDetails")
        .addEventListener("click", async () => {
          ...
          document
            .getElementsByClassName(
              "afBtn afBtn__fill afBtn--small af-primary btnViewDetails"
            )[0]
            .click();
        });
    } else {
      if (!document.getElementById("boxUseCalendarViews")) {
        ...
        if (document.getElementsByClassName("afCard").length == 5) {
          ...
          while (document.getElementsByClassName("afCard").length > 4) {
            if (
              document.getElementsByClassName("afCard")[4].childNodes[1]
                .textContent == "Saving ..."
            ) {
              await new Promise((r) => setTimeout(r, 10));
              console.log(":p");
        ...
        if (listOfTechs.length == 1) {
          ...
          for (let i = 0; i < table.length; i++) {
            if (listOfTechs.includes(table[i].children[4].innerText)) {
              ...
              table[
                i
              ].parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.parentElement.children[0].children[1].click();
          ...
          var mapBox = document.getElementsByClassName(
          ...
          var mapArea =
            mapBox.children[1].children[0].children[0].children[0].children[0]
              .children[0].children[0];
          mapArea.style.height = "600px";
          mapArea.style.width = "600px";

          var techTableBox =
            table[0].parentElement.parentElement.parentElement.parentElement
              .parentElement.parentElement.parentElement.parentElement
              .parentElement.parentElement.parentElement.parentElement;
          var initX = techTableBox.style.left;
          var initY = techTableBox.style.top;
          mapBox.style.top = techTableBox.style.top;
          techTableBox.style.left =
            String(parseInt(initX) - parseInt(techTableBox.style.width) / 2) +
            "px";
          mapBox.style.left =
            String(parseInt(initX) + parseInt(techTableBox.style.width) / 2) +
            "px";
        ...
        while (
          document.getElementsByClassName(
            "schedStartTime vd_required vd_time  afTextfield__input afTextfield__input--small ui-timepicker-input"
          ).length == 0
        ) {
          await new Promise((r) => setTimeout(r, 10));
          console.log("waiting for technician entry");
        ...
        document
          .getElementsByClassName("ui-dialog-titlebar-close ui-corner-all")[0]
          .click();
        if (
          document.getElementsByClassName(
            "ui-dialog ui-widget ui-widget-content ui-corner-all ui-draggable ui-resizable"
          ...
          if (mapBox.children[0].children[0].innerHTML == "Map")
            mapBox.children[0].children[1].click();
        }
      }
      while (document.getElementById("btnSelect")) {
        await new Promise((r) => setTimeout(r, 10));
      }
      schedLoop: while (true) {
        while (
          document.getElementsByClassName(
            "schedStartTime vd_required vd_time  afTextfield__input afTextfield__input--small ui-timepicker-input"
          ).length == 0 ||
          !document.getElementsByClassName(
            "schedNote afTextfield__input afTextfield__input--small vd_length"
          )[0].value == ""
        ) {
          await new Promise((r) => setTimeout(r, 10));
          ...
          if (
            document.getElementsByClassName(
              "afBtn afBtn__fill af-primary fc-button-today ui"
            ) &&
            !document.getElementById("ui-dialog-title-dlgSchedDetails")
          )
            return;
        }
        if (
...
var searchPostcode2 = async function (postcode) {
  ...
  if (listOfTechs.length == 0)
    alert(
      "postcode " +
        postcode +
        " not assigned to any technicians, may be out of area"
    );
};
