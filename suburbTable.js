const suburbTable = {
    ...
    "2096": ["QUEENSCLIFF", "CURL CURL", "HARBORD", "FRESHWATER"],
    "2097": ["COLLAROY", "COLLAROY BEACH", "COLLAROY PLATEAU WEST", "LONG REEF", "WHEELER HEIGHTS", "COLLAROY PLATEAU"],
    ...
    "2126": ["CHERRYBROOK"],
    "2127": ["NEWINGTON", "HOMEBUSH BAY","WENTWORTH POINT"],
    "2128": ["SILVERWATER"],
    "2129": ["SYDNEY MARKETS"],
    "2130": ["SUMMER HILL"],
    "2131": ["ASHFIELD"],
    ...
    "2765": ["ANGUS", "BERKSHIRE PARK", "BOX HILL", "GABLES", "GRANTHAM FARM","MARAYLYA","MARSDEN PARK","MELONBA","NELSON","OAKVILLE", "RIVERSTONE","VINEYARD"],
    "2768": ["GLENWOOD", "PARKLEA", "STANHOPE GARDENS"],
    "2769": ["THE PONDS"],
    //queensland
    "4000": ["BRISBANE", "BRISBANE ADELAIDE STREET", "BRISBANE ADELAIDE STREET", "BRISBANE CITY", "BRISBANE CITY DC", "BRISBANE GPO", "BRISBANE-CITY", "PARLIAMENT HOUSE", "PETRIE TERRACE", "SPRING HILL"],
    "4005": ["NEW FARM", "TENERIFFE"],
    "4007": ["ASCOT", "BRISBANE AIRPORT", "DOOMBEN", "HAMILTON", "HAMILTON CENTRAL", "WHINSTANES"],
    "4008": ["BRISBANE AIRPORT", "BULWER ISLAND", "MEEANDAH", "MYRTLETOWN", "PINKENBA"],
    "4009": ["EAGLE FARM", "EAGLE FARM BC"],
    "4010": ["ALBION", "ALBION BC", "ALBION DC", "BREAKFAST CREEK"],
    "4011": ["CLAYFIELD", "EAGLE JUNCTION", "HENDRA"],
    "4012": ["NUNDAH", "TOOMBUL", "WAVELL HEIGHTS", "WAVELL HEIGHTS NORTH"],
    "4013": ["NORTHGATE", "NORTHGATE MC"],
    "4014": ["BANYO", "NUDGEE","NUDGEE BEACH","VIRGINIA","VIRGINIA BC", "VIRGINIA DC"],
    "4017": ["BRACKEN RIDGE","BRIGHTON", "BRIGHTON EVENTIDE", "BRIGHTON NATHAN STREET", "DEAGON", "NASHVILLE", "SANDGATE", "SANDGATE DC", "SHORNCLIFFE"],
    "4018": ["FITZGIBBON", "TAIGUM"],
    "4019": ["CLONTARF", "CLONTARF BEACH", "CLONTARF DC", "HUMPYBONG", "MARGATE", "MARGATE BEACH", "SCOTTS POINT", "WOODY POINT"],
    "4020": ["NEWPORT", "REDCLIFFE", "REDCLIFFE NORTH", "SCARBOROUGH"],
    "4021": ["KIPPA-RING"],
    "4022": ["ROTHWELL"],
    "4030": ["EILDON HILL", "KALINGA", "LUTWYCHE", "WINDSOR", "WOOLOOWIN"],
    "4031": ["GLEN KEDRON", "GORDON PARK", "KEDRON"],
    "4032": ["CHERMSIDE", "CHERMSIDE BC", "CHERMSIDE CENTRE", "CHERMSIDE SOUTH", "CHERMSIDE WEST", "CRAIGSLEA"],
    "4034": ["ASPLEY", "BOONDALL", "CARSELDINE", "GEEBUNG", "ZILLMERE"],
    "4035": ["ALBANY CREEK", "BRIDGEMAN DOWNS", "CASHS CROSSING"],
    "4036": ["BALD HILLS"],
    "4037": ["EATONS HILL"],
    "4051": ["ALDERLEY", "ENOGGERA", "GAYTHORNE", "GRANGE", "NEWMARKET", "THE GRANGE", "WILSTON"],
    "4053": ["BROOKSIDE CENTRE", "EVERTON HILLS", "EVERTON PARK", "MCDOWALL", "MITCHELTON", "OXFORD PARK", "SOMERSET HILLS", "STAFFORD", "STAFFORD BC", "STAFFORD CITY", "STAFFORD DC", "STAFFORD HEIGHTS"],
    "4054": ["ARANA HILLS", "GROVELY", "KEPERRA"],
    "4055": ["BUNYA", "FERNY GROVE", "FERNY HILLS", "FERNY HILLS DC", "KEDRON UPPER", "UPPER KEDRON"],
    "4059": ["BALLYMORE", "ITHACA", "KELVIN GROVE", "KELVIN GROVE BC", "KELVIN GROVE DC", "NORMANBY", "RED HILL"],
    "4060": ["ASHGROVE", "ASHGROVE EAST", "ASHGROVE WEST", "DORRINGTON", "ST JOHNS WOOD"],
    "4061": ["THE GAP"],
    "4064": ["BAROONA", "MILTON", "MILTON BC", "PADDINGTON", "ROSALIE"],
    "4101": ["HIGHGATE HILL", "MATER HILL", "MATER HOSPITAL", "SOUTH BANK", "SOUTH BRISBANE", "SOUTH BRISBANE BC", "WEST END"],
    "4102": ["BURANDA", "DUTTON PARK", "PRINCESS ALEXANDRA HOSPITAL", "WOOLLOONGABBA"], 
    "4112": ["KURABY"],
    ...
    "4169": ["EAST BRISBANE", "KANGAROO POINT", "STANLEY BRIDGE"],
    "4170": ["CANNON HILL", "COLMSLIE", "MORNINGSIDE", "NORMAN PARK", "SEVEN HILLS"],
    "4171": ["BALMORAL", "BULIMBA", "GALLOWAYS HILL", "HAWTHORNE"],
    "4172": ["MURARRIE"],
    "4173": ["TINGALPA", "TINGALPA BC", "TINGALPA DC"],
    "4174": ["DOBOY", "HEMMANT"],
    ...
    "4500": ["BRAY PARK", "BRENDALE", "BRENDALE BC", "BRENDALE DC", "CASHMERE", "CLEAR MOUNTAIN", "JOYNER", "STRATHPINE", "STRATHPINE CENTRE", "STRATHPINE CITY", "WARNER"],
    "4501": ["LAWNTON"],
    "4502": ["FRENCHS FOREST", "PETRIE"],
    "4503": ["DAKABIN", "DOHLES ROCKS", "GRIFFIN", "KALLANGUR", "KURWONGBAH", "MURRUMBA DOWNS", "WHITESIDE"],
    "4504": ["NARANGBA"],
    "4505": ["BURPENGARY", "BURPENGARY DC", "BURPENGARY EAST"],
    "4508": ["DECEPTION BAY"],
    "4509": ["MANGO HILL", "NORTH LAKES"],
    "4520": ["ARMSTRONG CREEK", "CAMP MOUNTAIN", "CEDAR CREEK", "CLOSEBURN", "DRAPER", "ENOGGERA RESERVOIR", "HIGHVALE", "JOLLYS LOOKOUT", "KOBBLE CREEK", "MOUNT GLORIOUS", "MOUNT NEBO", "MOUNT SAMSON", "SAMFORD", "SAMFORD VALLEY", "SAMFORD VILLAGE", "SAMSONVALE", "WIGHTS MOUNTAIN", "YUGAR"],
    "4521": ["CAMPBELLS POCKET", "DAYBORO", "KING SCRUB", "LACEYS CREEK", "MOUNT MEE", " MOUNT PLEASANT", "OCEAN VIEW", "RUSH CREEK"],
    //Western australia
